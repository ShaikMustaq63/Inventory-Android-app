...
public class MainActivity extends Activity {
	...
	public boolean onOptionsItemSelected(MenuItem item) {
		...
		{
		case 0: startActivityForResult(new Intent(MainActivity.this,MainActivity.class),0);break;
		
		case 1: startActivityForResult(new Intent(MainActivity.this,Customers.class),0);break;
		
		case 2: startActivityForResult(new Intent(MainActivity.this,Items.class),0);break;
		
case 3: startActivityForResult(new Intent(MainActivity.this,Orders.class),0);break;
		
		case 4: startActivityForResult(new Intent(MainActivity.this,Sell.class),0);break;
		case 5: startActivityForResult(new Intent(MainActivity.this,Account.class),0);break;
		default: {  AlertDialog.Builder adb=new AlertDialog.Builder(MainActivity.this);
